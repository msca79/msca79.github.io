<?php 
//$basePath = (strpos($_SERVER['SCRIPT_NAME'] ?? '', '/altalanos/') !== false ||
//             strpos($_SERVER['SCRIPT_NAME'] ?? '', '/elet/') !== false ||
//             strpos($_SERVER['SCRIPT_NAME'] ?? '', '/gimnazium/') !== false ||
...
$laptop_admin_email = "marton.szabolcs@gmail.com";
?>